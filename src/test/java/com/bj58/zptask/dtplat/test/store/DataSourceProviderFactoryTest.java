//package com.bj58.zptask.dtplat.test.store;
//
//import com.bj58.zptask.dtplat.commons.DataSourceProvider;
//import com.bj58.zptask.dtplat.commons.DataSourceProviderFactory;
...
//        connection.prepareStatement("CREATE TABLE lts_node (" + "  identity varchar(32) NOT NULL," + "  available tinyint ," + "  clusterName varchar(64) ," + "  nodeType varchar(16) ," + "  ip varchar(16) ," + "  port int ," + "  nodeGroup varchar(64) ," + "  createTime bigint ," + "  threads int ," + "  PRIMARY KEY (identity)," + "  KEY idx_clusterName (clusterName)" + ");").execute();
//
