package com.bj58.zptask.dtplat.core.logger.support;
...
public class MessageFormatter {
     ...
     *            The message pattern which will be parsed and formatted The
     *            argument to be substituted in place of the formatting anchor
